...
const sources = [
  "schema/root.graphql",
  "schema/modules/identity.graphql",
  "schema/modules/admissions.graphql",
  "schema/modules/settings.graphql",
  "schema/modules/academics.graphql",
  "schema/modules/finance.graphql",
  "schema/modules/platform.graphql",
];
