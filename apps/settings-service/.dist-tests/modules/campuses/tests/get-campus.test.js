...
(0, node_test_1.default)("get campus returns only the stored campus", async () => {
    ...
    const result = await (0, use_cases_1.getCampusUseCase)(context, created.id, { repository });
    strict_1.default.equal(result?.code, "MAIN");
});
