...
(0, node_test_1.default)("update academic year changes fields", async () => {
    ...
    const updated = await (0, use_cases_1.updateAcademicYearUseCase)(context, created.id, { name: "Updated Year" }, { repository });
    strict_1.default.equal(updated?.name, "Updated Year");
});
