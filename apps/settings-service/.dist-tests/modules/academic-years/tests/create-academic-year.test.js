...
(0, node_test_1.default)("create academic year stores the record", async () => {
    ...
    const result = await (0, use_cases_1.createAcademicYearUseCase)(context, (0, fixtures_1.createAcademicYearFixture)(), { repository });
    strict_1.default.equal(result.code, "2025-26");
    strict_1.default.equal(result.status, "INACTIVE");
});
