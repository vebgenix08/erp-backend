...
(0, node_test_1.default)("activate academic year marks it active", async () => {
    ...
    const activated = await (0, use_cases_1.activateAcademicYearUseCase)(context, created.id, { repository });
