...
import { updateInvite } from "../invites.service";

export async function updateInviteUseCase(id: string, input: unknown, context: RequestContext, deps?: InviteServiceDeps) {
