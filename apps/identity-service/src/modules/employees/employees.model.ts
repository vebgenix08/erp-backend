...
export interface EmployeeRecord {
  ...
  pendingRoleIds?: string[] | undefined;
  pendingScopeType?: "TENANT" | "CAMPUS" | undefined;
...
export interface EmployeeListFilter {
  ...
  loginStatus?: EmployeeLoginStatus | undefined;
  page?: number | undefined;
  pageSize?: number | undefined;
  sortBy?: EmployeeSortField | undefined;
  sortDirection?: EmployeeSortDirection | undefined;
}
export interface EmployeePageSummary {
  total: number;
  active: number;
  teaching: number;
  nonTeaching: number;
...
export interface StaffIdentityGateway {
  invite(input: {
    ...
    tenantId: string;
    roleCode: string;
  }): Promise<{ username: string; subject?: string | undefined }>;
...
export interface EmployeeInviteAttempt {
  ...
  status: EmployeeInviteAttemptStatus;
  provider: "COGNITO";
