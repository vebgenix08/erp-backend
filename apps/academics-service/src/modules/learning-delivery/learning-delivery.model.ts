...
export interface ParallelTimetableBlock extends AuditRecord {
  ...
  name: string;
  code: string;
  type: "SUBJECT_CHOICE" | "LANGUAGE" | "ELECTIVE" | "ROTATION";
  sourceSectionIds: string[];
  requiredOfferingIds: string[];
  mustRunSimultaneously: boolean;
  status: ActiveStatus;
}
