...
export async function getSectionUseCase(id: string, context: RequestContext, deps?: SectionServiceDeps): Promise<SectionView | null> {
  ...
  return toSectionView(await repository.getById(requireSectionTenantId(context), id));
}
