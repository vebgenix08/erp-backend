...
export class AppSyncStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: AppSyncStackProps) {
    ...
    for (const fieldName of [
      ...
      "curriculumSubjects",
      "subjectComponents",
      "academicYearSubjectPlans",
      "sectionSubjectExceptions",
      "subjectChoiceGroups",
      "studentSubjectChoices",
      "teachingGroups",
      "teachingGroupMemberships",
      "subjectBatches",
      "subjectBatchMemberships",
      "subjectOfferings",
      "parallelTimetableBlocks",
      "employeeCampusAssignments",
      "teacherSubjectEligibility",
      "offeringTeacherAssignments",
      ...
      "campusTravelRules",
      "timetablePeriodSets",
      "timetablePeriodSlots",
      "timetableVersions",
      "timetableEntries",
      "timetableReadiness",
      "timetableValidationRuns",
      "timetableConflicts",
    ...
    for (const fieldName of [
      ...
      "createSubjectCatalogueItem",
      "updateSubjectCatalogueItem",
      "deactivateSubjectCatalogueItem",
      "createCurriculumSubject",
      "updateCurriculumSubject",
      "deactivateCurriculumSubject",
      "createSubjectComponent",
      "deactivateSubjectComponent",
      "createAcademicYearSubjectPlan",
      "activateAcademicYearSubjectPlan",
